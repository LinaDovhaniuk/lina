...
#include "../../../../../../../OP/project/LoginForm/adminform.h"
...
QT_MOC_LITERAL(3, 32, 29), // "on_ClientReviewButton_clicked"
QT_MOC_LITERAL(4, 62, 23), // "on_adminTable_activated"
QT_MOC_LITERAL(5, 86, 5), // "index"
QT_MOC_LITERAL(6, 92, 16) // "slotUpdateModels"

    },
    "AdminForm\0on_addButton_clicked\0\0"
    "on_ClientReviewButton_clicked\0"
    "on_adminTable_activated\0index\0"
    "slotUpdateModels"
};
...
void AdminForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AdminForm *_t = static_cast<AdminForm *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_addButton_clicked(); break;
        case 1: _t->on_ClientReviewButton_clicked(); break;
        case 2: _t->on_adminTable_activated((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        case 3: _t->slotUpdateModels(); break;
        default: ;
        }
    }
}

const QMetaObject AdminForm::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_AdminForm.data,
      qt_meta_data_AdminForm,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AdminForm::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AdminForm.stringdata0))
        return static_cast<void*>(const_cast< AdminForm*>(this));
